...
class HotelPage extends Component<Props, State> {
  ...
  loadListings = async () => {
    ...
    try {
      ...
      let response = await fetch(`/list?page=${page + 1}&records=8`, {
        headers
      });
      ...
      <Fragment>
        <div className="search-summary">
          <div className="average">
            Over 8,000 booking reviews in Dubai, with an average of rating of 8.
          </div>
        ...
        <ScrollView loading={requestSent} loadData={this.loadListings}>
