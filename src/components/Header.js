    ...
    <div className="navbar">
      <div className="left">
        ...
        <div className="search-input">
          <div className="search-icon"><span role="img" aria-label="Search">&#128269;</span></div>
          <input placeholder="Downtown Dubai, United Arab Emirates" />
          <div className="search-date">April <span className="day-circle">29</span> <span className="day-circle">30</span></div>
        </div>
      </div>
